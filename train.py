...
from utils.dataset import COCODataset, collateFunction
...
def main(args):
    ...
    dataset = COCODataset(args.dataDir, args.annFile, args.targetHeight, args.targetWidth, args.numClass)
...
if __name__ == '__main__':
    ...
    # MARK: - dataset
    parser.add_argument('--dataDir', default='./data/sketchyCOCO/Scene/Sketch/paper_version/trainInTrain', type=str)
    parser.add_argument('--annFile', default='./coco_dataset.json', type=str)
